#' Focus Bioinformatics Report (PDF)
#'
#' This function can be used to render the Focus Bioinformatics report. The design
...
#' \code{"Focus"} to use the default example template
...
#'
#' @export
businessReport <- function(template = "Focus", resetStyleFiles = FALSE,...) {

  # The following code is taken from rmarkdown::pdf_document() (v1.1)
  # template path and assets

  if (identical(template, "Focus")) {
